...
<li><a href="mobile.php" class="active" style="font-weight: 400"><i class="fa fa-star"></i> Phone</a></li>
...
<!--features_items-->
<h2 class="title text-center">Phones</h2>
...
$sql = "SELECT * FROM products WHERE description='Phone' ORDER BY F_ID DESC";
