...
<li><a href="desktop.php" class="active" style="font-weight: 400"><i class="fa fa-star"></i> Desktop</a></li>

<li><a href="laptop.php"  style="font-weight: 400"><i class="fa fa-star"></i>Laptop</a></li>
...
<!--features_items-->
<h2 class="title text-center"> Desktops</h2>
...
$sql = "SELECT * FROM products WHERE description='Desktop' ORDER BY F_ID";
